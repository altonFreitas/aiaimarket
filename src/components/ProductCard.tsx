...
import {discountPercent, ratingAverage, stars} from "@/lib/utils";
      ...
      <div className="body">
        ...
        {pct != null ? (
          <div className="pr-row">
            <span className="pr-discount">{m(p.discount_price!)}</span>
            <span className="pr-original">{m(p.price)}</span>
            <span className="pr-pct">-{pct}%</span>
          </div>
        ) : (
          <div className="pr">{m(p.price)}</div>
        )}
